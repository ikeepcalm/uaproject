...
public class WikiView extends VerticalLayout {
    ...
    public WikiView() {
        ...
        rolesQuestions.addQuestion(new WikiCard("Що дає роль Спонсора?", "Ви можете заснувати місто певної території, яка відповідає рівню спонсорства. До того ж ви отримуєте доступ до декількох можливостей зробити із гостів (можливо, своїх друзів) повноцінних гравців, і обмежену кількість глобальних повідомлень на весь сервер поштою!"));
