package dev.ua.ikeepcalm.views.вікіпедія;
...
public class ВікіпедіяView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ВікіпедіяView() {
        addClassName("вікіпедія-view");
        setSizeFull();
        grid.setHeight("100%");
